...
BEGIN
    ...
    result_json = json_build_object('user_name', display_name, 'phone', phone_number, 'email', email_arg, 'record_code', record_code_registered, 'credentials', credentials_id, 'user_status', status_arg, 'register_date', current_datetime::text);
    RETURN result_json;
END;
$$;